...
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+pymysql://Huuser:12345@localhost/users'
app.config['SECRET_KEY'] = 'a really really really really long secret key'
app.config['UPLOAD_FOLDER'] = 'static/images/'

db = DataBase('localhost','Huuser','12345','users')
    ...
    if request.method == 'POST':
        ...
        if user[5] == 'y':
            ...
            if not request.form['pin-code'] == '1448':
                return render_template('login.html', PIN = True,password=password,email=email,error='Не верный пин-код')
